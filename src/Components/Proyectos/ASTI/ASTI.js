...
const ASTI = () => {
  return (
    <div className="asti-container">
      <h1>ASTI Challenge 2025</h1>
      <p>
      We are preparing to participate in the ASTI Robotics Challenge, a prominent robotics competition in Spain that encourages the development of mobile robotics projects. This year, we are competing in the university category, where teams are tasked with designing, building, and prototyping autonomous robots that can perform complex tasks.
      </p>
      <p>
